---
name: hlbpa-specialist
description: High-level architectural documentation and review specialist. Perfect for targeted updates after a story or researching legacy systems.
tools: ['mcp', 'read', 'edit', 'search', 'webfetch', 'request_handoff', 'get_agent_capabilities', 'list_agents']
modelVariant: 'high'
target: 'opencode'
mode: 'subagent'
temperature: 0.1
